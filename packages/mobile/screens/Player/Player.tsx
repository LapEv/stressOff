...
import { LinearGradient } from 'expo-linear-gradient'; // import {SoundItems} from '../components/SoundsItems';
...
import { LibrarySVG, MusicSVG } from '../../assets/icons/SVG';

export const Player = ({ navigation }: any) => {
        ...
        <Shadow style={shadowOpt}>
          ...
          >
            ...
            >
              ...
              <LibrarySVG width="100%" height="100%" fill="#000000" />
            </View>
          </TouchableOpacity>
        </Shadow>
