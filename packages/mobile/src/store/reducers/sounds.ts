...
import { IActionSoundState, ISoundState } from '../interfaces'
import {
  ADD_SOUND,
  REMOVE_SOUND,
  TOGGLE_ALL_SOUND,
...
export const soundReducer: Reducer<ISoundState, IActionSoundState> = (
  state = initialState,
  action,
) => {
  switch (action.type) {
    ...
    case TOGGLE_START_SOUND:
      return {
        ...state,
        soundStart: action.payload.soundStart,
      }
